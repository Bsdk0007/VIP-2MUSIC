...
async def start(_, msg):
    buttons = [
        [
            InlineKeyboardButton(
                "𝗔𝗗𝗗 𝗠𝗘", url=f"https://t.me/RADHE_MUSIC_ROBOT?startgroup=true"
            )
        ],
        [
        ...
        [
            InlineKeyboardButton(
                "𝗜𝗠𝗔𝗚𝗘 𝗚𝗘𝗡𝗘𝗥𝗔𝗧𝗘𝗥", url=f"https://t.me/Image_generaterbot"
            ),
        ],
    ]
    ...
    await msg.reply_photo(
        photo="https://envs.sh/bJh.jpg", caption=start_txt, reply_markup=reply_markup
    )
